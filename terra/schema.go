...
var (
	...
	ValidInstances = map[string]awsInstance{
		"a1.medium":     awsInstance{Type: "a1.medium", Memory: "2048", Cpu: "1024"},
		"a1.large":      awsInstance{Type: "a1.large", Memory: "4096", Cpu: "2048"},
		"a1.xlarge":     awsInstance{Type: "a1.xlarge", Memory: "8192", Cpu: "4096"},
		"a1.2xlarge":    awsInstance{Type: "a1.2xlarge", Memory: "16384", Cpu: "8192"},
		"a1.4xlarge":    awsInstance{Type: "a1.4xlarge", Memory: "32768", Cpu: "16384"},
		"t3.nano":       awsInstance{Type: "t3.nano", Memory: "512", Cpu: "2048"},
		"t3.micro":      awsInstance{Type: "t3.micro", Memory: "1024", Cpu: "2048"},
		"t3.small":      awsInstance{Type: "t3.small", Memory: "2048", Cpu: "2048"},
		"t3.medium":     awsInstance{Type: "t3.medium", Memory: "4096", Cpu: "2048"},
		"t3.large":      awsInstance{Type: "t3.large", Memory: "8192", Cpu: "2048"},
		"t3.xlarge":     awsInstance{Type: "t3.xlarge", Memory: "16384", Cpu: "4096"},
		"t3.2xlarge":    awsInstance{Type: "t3.2xlarge", Memory: "32768", Cpu: "8192"},
		"t3a.nano":      awsInstance{Type: "t3a.nano", Memory: "512", Cpu: "2048"},
		"t3a.micro":     awsInstance{Type: "t3a.micro", Memory: "1024", Cpu: "2048"},
		"t3a.small":     awsInstance{Type: "t3a.small", Memory: "2048", Cpu: "2048"},
		"t3a.medium":    awsInstance{Type: "t3a.medium", Memory: "4096", Cpu: "2048"},
		"t3a.large":     awsInstance{Type: "t3a.large", Memory: "8192", Cpu: "2048"},
		"t3a.xlarge":    awsInstance{Type: "t3a.xlarge", Memory: "16384", Cpu: "4096"},
		"t3a.2xlarge":   awsInstance{Type: "t3a.2xlarge", Memory: "32768", Cpu: "8192"},
		"t2.nano":       awsInstance{Type: "t2.nano", Memory: "512", Cpu: "1024"},
		"t2.micro":      awsInstance{Type: "t2.micro", Memory: "1024", Cpu: "1024"},
		"t2.small":      awsInstance{Type: "t2.small", Memory: "2048", Cpu: "1024"},
		"t2.medium":     awsInstance{Type: "t2.medium", Memory: "4096", Cpu: "2048"},
		"t2.large":      awsInstance{Type: "t2.large", Memory: "8192", Cpu: "2048"},
		"t2.xlarge":     awsInstance{Type: "t2.xlarge", Memory: "16384", Cpu: "4096"},
		"t2.2xlarge":    awsInstance{Type: "t2.2xlarge", Memory: "32768", Cpu: "8192"},
		"m5.large":      awsInstance{Type: "m5.large", Memory: "8192", Cpu: "2048"},
		"m5.xlarge":     awsInstance{Type: "m5.xlarge", Memory: "16384", Cpu: "4096"},
		"m5.2xlarge":    awsInstance{Type: "m5.2xlarge", Memory: "32768", Cpu: "8192"},
		"m5.4xlarge":    awsInstance{Type: "m5.4xlarge", Memory: "65536", Cpu: "16384"},
		"m5.8xlarge":    awsInstance{Type: "m5.8xlarge", Memory: "131072", Cpu: "32768"},
		"m5.12xlarge":   awsInstance{Type: "m5.12xlarge", Memory: "196608", Cpu: "49152"},
		"m5.16xlarge":   awsInstance{Type: "m5.16xlarge", Memory: "262144", Cpu: "65536"},
		"m5.24xlarge":   awsInstance{Type: "m5.24xlarge", Memory: "393216", Cpu: "98304"},
		"m5.metal":      awsInstance{Type: "m5.metal", Memory: "393216", Cpu: "98304"},
		"m5d.large":     awsInstance{Type: "m5d.large", Memory: "8192", Cpu: "2048"},
		"m5d.xlarge":    awsInstance{Type: "m5d.xlarge", Memory: "16384", Cpu: "4096"},
		"m5d.2xlarge":   awsInstance{Type: "m5d.2xlarge", Memory: "32768", Cpu: "8192"},
		"m5d.4xlarge":   awsInstance{Type: "m5d.4xlarge", Memory: "65536", Cpu: "16384"},
		"m5d.8xlarge":   awsInstance{Type: "m5d.8xlarge", Memory: "131072", Cpu: "32768"},
		"m5d.12xlarge":  awsInstance{Type: "m5d.12xlarge", Memory: "196608", Cpu: "49152"},
		"m5d.16xlarge":  awsInstance{Type: "m5d.16xlarge", Memory: "262144", Cpu: "65536"},
		"m5d.24xlarge":  awsInstance{Type: "m5d.24xlarge", Memory: "393216", Cpu: "98304"},
		"m5d.metal":     awsInstance{Type: "m5d.metal", Memory: "393216", Cpu: "98304"},
		"m5a.large":     awsInstance{Type: "m5a.large", Memory: "8192", Cpu: "2048"},
		"m5a.xlarge":    awsInstance{Type: "m5a.xlarge", Memory: "16384", Cpu: "4096"},
		"m5a.2xlarge":   awsInstance{Type: "m5a.2xlarge", Memory: "32768", Cpu: "8192"},
		"m5a.4xlarge":   awsInstance{Type: "m5a.4xlarge", Memory: "65536", Cpu: "16384"},
		"m5a.8xlarge":   awsInstance{Type: "m5a.8xlarge", Memory: "131072", Cpu: "32768"},
		"m5a.12xlarge":  awsInstance{Type: "m5a.12xlarge", Memory: "196608", Cpu: "49152"},
		"m5a.16xlarge":  awsInstance{Type: "m5a.16xlarge", Memory: "262144", Cpu: "65536"},
		"m5a.24xlarge":  awsInstance{Type: "m5a.24xlarge", Memory: "393216", Cpu: "98304"},
		"m5ad.large":    awsInstance{Type: "m5ad.large", Memory: "8192", Cpu: "2048"},
		"m5ad.xlarge":   awsInstance{Type: "m5ad.xlarge", Memory: "16384", Cpu: "4096"},
		"m5ad.2xlarge":  awsInstance{Type: "m5ad.2xlarge", Memory: "32768", Cpu: "8192"},
		"m5ad.4xlarge":  awsInstance{Type: "m5ad.4xlarge", Memory: "65536", Cpu: "16384"},
		"m5ad.12xlarge": awsInstance{Type: "m5ad.12xlarge", Memory: "196608", Cpu: "49152"},
		"m5ad.24xlarge": awsInstance{Type: "m5ad.24xlarge", Memory: "393216", Cpu: "98304"},
		"m4.large":      awsInstance{Type: "m4.large", Memory: "8192", Cpu: "2048"},
		"m4.xlarge":     awsInstance{Type: "m4.xlarge", Memory: "16384", Cpu: "4096"},
		"m4.2xlarge":    awsInstance{Type: "m4.2xlarge", Memory: "32768", Cpu: "8192"},
