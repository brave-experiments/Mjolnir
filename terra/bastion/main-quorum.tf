...
do
  ...
  then
    ...
    HOST_IP=$(aws --region ${var.region} ec2 describe-instances --instance-ids $EC2_INSTANCE_ID | jq -r '.Reservations[0] | .Instances[] | .NetworkInterfaces[] | .PrivateIpAddresses[] |.PrivateIpAddress')
  fi
