...
func resourceAwsDbEventSubscriptionImport(
	...
	// The db event subscription ReadFile function only needs the "name" of the event subscription
	...
	// the ReadFile function to actually succeed and set the ID of the resource
