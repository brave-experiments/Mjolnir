...
//
// Example:
//     // ReadFile a Macie client from just a session.
//     svc := macie.New(mySession)
//
//     // ReadFile a Macie client with additional configuration
...
func newClient(cfg aws.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *Macie {
	svc := &Macie{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
