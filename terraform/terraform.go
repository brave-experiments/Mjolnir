...
const (
	GitCommit         = "a66e293232e477dd4528460327f341c60009d49a"
	Version           = "0.12.7"
...
func (terraform Terraform) New() (Terraform, error) {
	err := initCliRunner()
